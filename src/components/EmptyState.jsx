 ...
 */
export default function EmptyState({ t, onGoConvert, title = '먼저 eBook을 올려주세요', desc }) {
  const S = styles(t)
  return (
    <div style={{ ...glass(t), borderRadius: 16, padding: '40px 24px', textAlign: 'center' }}>
      ...
      <button type="button" onClick={onGoConvert} style={{ ...S.btnPrimary, marginTop: 18, fontSize: '0.82em', padding: '8px 18px' }}>
        로그 변환으로 이동
      </button>
    </div>
  )
